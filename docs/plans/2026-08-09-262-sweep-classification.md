...
| 6 | `build/failure-recovery.md`'s "built-in retry" deferral is backed by SDD's re-dispatch/escalation ladder | `provide more context and re-dispatch with the same model` | `skills/subagent-driven-development/SKILL.md:245` — confirmed |
