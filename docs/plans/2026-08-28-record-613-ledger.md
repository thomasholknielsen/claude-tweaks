...
| 9 | wrap-up | Residue sweep: PR #1585 (this run's own draft PR, head `worktree-dispatch-record-613`) still open. | open | Not yet mergeable — no `auto:merge` grant on #613; expected for a pr-first draft run |
