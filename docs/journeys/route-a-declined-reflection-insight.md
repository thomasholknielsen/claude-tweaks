...
- **Should understand:** The annotation is advisory. The recommendation column still shows a real, independent call (Implement now / Defer / Capture / Don't capture) — the maintainer is free to disagree with the earlier decline and capture the insight this time, especially if the annotation's reason no longer applies.
