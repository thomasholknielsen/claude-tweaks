...
**Goal:** Watch one profile resolve under four configurations and confirm the returned `model`/`effort`/`source` change exactly as `plugin/skills/_shared/subagent-output-contract.md` §Model Selection says they will.
