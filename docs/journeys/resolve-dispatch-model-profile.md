...
**Goal:** Watch one profile resolve under three configurations and confirm the returned `model`/`effort`/`source` change exactly as `skills/_shared/subagent-output-contract.md` §Model Selection says they will.
