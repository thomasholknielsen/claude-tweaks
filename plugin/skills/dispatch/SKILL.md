---
name: dispatch
description: "Use to select and dispatch authorized GitHub records to /flow — the gate-to-executor queue consumer. Bare drain (--budget) or #N direct. Keywords - dispatch, queue, claim, auto:build, auto:merge, bot:in-progress, bot:blocked, bot:parked, autonomous build, routine."
