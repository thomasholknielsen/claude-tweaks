...
| `dispatch-group-size-guard` | `10` | Caps a file-overlap group's size before headless `next` excludes it (`dispatch-oversized-excluded.json`, #1228); bare/`#N` still resolve it — a present human is the required surfacing. |
