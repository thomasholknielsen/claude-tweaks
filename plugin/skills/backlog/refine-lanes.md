...
during the run by Step 3.5 downgrades) → Needs-decision (populated by `grant-lane-decision.md`'s
...
`25` suggestions across `8` lanes: `2` re-authorize, `1` re-triage (parked), `7` grant, `3` flag-back, `1` needs-decision,
