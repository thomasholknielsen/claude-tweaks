...
body. Rendered output with no such line is a grant-unit failure for that candidate: skip it,
report it in Step 5's summary, and never default to a grant or a refusal.
