...
4. After resolution, fold each finding back into its own Step 7 summary section ("Design Quality" / "Visual Review"), noting its final status (fixed / deferred / accepted).
