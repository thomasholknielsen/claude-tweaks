...
section that reached this staging step: a section that fails to clear the floor, with a
...
or that clears the floor, proceeds to the ordinary staging steps below unchanged.
