...
| `grant-veto-window-hours` | `policy.yml` | `/claude-tweaks:dispatch`'s Auto-merge gate (`dispatch/settle-and-merge.md`) | `24` | How long a machine-granted `auto:merge-pending` grant must sit unvetoed before dispatch matures it to `auto:merge` (#309) |
