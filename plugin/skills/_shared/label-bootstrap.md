...
[
  ...
  ["bot:blocked",       "Bot state: hit the retry ceiling — grants revoked, needs human re-authorization"],
  ["bot:parked",        "Bot state: merge-verification park — checks red/timed out, grants intact, needs re-triage"],
