...
The report follows the same structure as the standard Report & Route (Step 6 in `browser-review.md`) but adds journey-specific sections before the findings table:
