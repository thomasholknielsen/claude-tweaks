...
| `_shared/subagent-output-contract.md` | Steps 1, 3, 4, 4.5, 4.6, 4.7, 4.8, and 5.5 dispatch parallel Task agents per this contract — minimal input, status line first (`DONE / DONE_WITH_CONCERNS / NEEDS_CONTEXT / BLOCKED`), Template A inlined verbatim. Model tier: Fast. |
