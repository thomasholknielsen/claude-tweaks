...
readying and merging each one via `_shared/pr-first-merge.md`'s procedure (its Step 2.5
Merge-verification gate included — a red PR in the sequence parks and reports pending-review; the
remaining branches still merge in order) (`tag: fast-lane`,
