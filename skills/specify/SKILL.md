...
argument-hint: "<#N[,#M...]|record-id[,id...]|design-doc-path|topic|backlog-title>|#A-#B [phase-N] [--surface <web|mobile|desktop|backend|infra|terminal>] [--granularity <fine|standard|coarse>] [--chained]"
---
