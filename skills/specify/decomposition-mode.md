...
5. **The codebase** — identify existing files, schemas, APIs, and patterns that the new work will build on. This context is critical for writing sub-issue records that `/superpowers:writing-plans` can act on.
