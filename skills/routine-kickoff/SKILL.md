...
- **Terminal output.** This skill never renders a `## Next Actions` block — it is a wrapper that passes control entirely to its target skill, whose own Next Actions (if any) are what the user sees.
