...
const { domainChurn } = require('../churn');
...
test('domainChurn is a single shared cache across every consumer scope.js', () => {
  const harnessScope = require('../../harness-health/scope');
  const journeyScope = require('../../journey-health/scope');
  const docsScope = require('../../docs-health/scope');
