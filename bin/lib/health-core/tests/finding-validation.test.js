...
const { requireNonEmptyStrings, validateRelatedSections } = require('../finding-validation');
...
test('requireNonEmptyStrings and validateRelatedSections back every consumer validate-finding.js', () => {
  const { validateFinding: harnessValidate } = require('../../harness-health/validate-finding');
  const { validateFinding: journeyValidate } = require('../../journey-health/validate-finding');
  const { validateFinding: docsValidate } = require('../../docs-health/validate-finding');
