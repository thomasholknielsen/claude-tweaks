...
const { buildRelatedBlocks } = require('../related-blocks');
...
test('buildRelatedBlocks is the single shared implementation across every consumer issue-payload.js', () => {
  const harnessPayload = require('../../harness-health/issue-payload');
  const journeyPayload = require('../../journey-health/issue-payload');
  const docsPayload = require('../../docs-health/issue-payload');
