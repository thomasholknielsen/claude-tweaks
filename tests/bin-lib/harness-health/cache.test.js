...
const { cachePath, readCache, writeCache } = require('../../../bin/lib/harness-health/cache');
...
const { readDurableState, writeDurableState } = require('../../../bin/lib/harness-health/cache');
