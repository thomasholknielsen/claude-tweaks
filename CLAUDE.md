...
- Don't treat the bytes moved out of a file as an extraction's saving — measure what each resolved mode loads afterward, since the sub-file's header plus the stub left behind can exceed the branch that mode skips `[IL-74]`
