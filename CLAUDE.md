...
- Don't implement an issue body's own suggested fix or acceptance-criteria wording without measuring it against the live files first — it reads as authoritative but was written against a snapshot and never executed; the four health-sweep skills file such issues routinely `[IL-71]`
