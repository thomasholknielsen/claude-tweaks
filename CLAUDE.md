...
- **Assume zero cost and zero time.** Decide as if implementation is free and instant. Never choose an inferior design or a shortcut because the better approach "isn't worth the effort" or "takes too long."
